...
describe("App tests", () => {
  ...
  it("handleDisplayDrawer updates displayDrawer to true", () => {
    const component = shallow(<App />);
    component.instance().handleDisplayDrawer();
    expect(component.state("displayDrawer")).toBe(true);
  });

  it("handleHideDrawer updates displayDrawer to false", () => {
    const component = shallow(<App />);
    component.instance().handleDisplayDrawer(); // First make it true
    expect(component.state("displayDrawer")).toBe(true);
